                    ...
                    <div className="adjustment">
                        ...
                        <div className="about-text">
                            <p className="para-text">
                                I am a second-year student at the <a href="https://www.github.com/agamjolly" target="_blank" rel="noopener noreferrer">University of California, Berkeley</a> where I major in Computer Science. At UC Berkeley, I am a part of the coveted <a href="https://eecs.berkeley.edu/cs-scholars/data" target="_blank" rel="noopener noreferrer">CS Scholars</a> program. {/*In case you are interested in knowing what courses I took this year, click <a href="https://eecs.berkeley.edu/cs-scholars/data" target="_blank" rel="noopener noreferrer">here</a>.*/}<br /><br />

                                Prior to starting university, I did my high-schooling at Mayor World School, where I was declared the <a href="https://en.wikipedia.org/wiki/Head_girl_and_head_boy" target="_blank" rel="noopener noreferrer">Head Boy</a> for the graduating class of 2018-19. Around this time, I attended the prestigious <a href="https://launchx.com/" target="_blank" rel="noopener noreferrer">MIT LaunchX</a> on a full-ride scholarship where I founded <a href="https://launchx.com/companies" target="_blank" rel="noopener noreferrer">Eli Sleep</a>.<br /><br />
